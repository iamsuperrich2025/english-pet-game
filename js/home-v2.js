...
/* === Home V2 Locked Mobile Landscape Recovery ===
   Restores the original app/game-screen interaction model after the website-like
   responsive experiment. The page itself never becomes a long scroller.
   When space is tight, only the existing tool/icon rails scroll inside the
   locked lobby viewport. data-vw2-action/source wiring is untouched. */
@media (max-width:1100px) and (orientation:landscape) and (max-height:650px){
  ...
  #vw-home-v2-root .vw2-main-grid{
    display:grid!important;grid-template-columns:clamp(72px,11vw,92px) minmax(0,1fr) clamp(150px,23vw,195px)!important;
  ...
  #vw-home-v2-root .vw2-feed{display:none!important}

  #vw-home-v2-root .vw2-feature{
    grid-column:2!important;grid-row:1!important;height:100%!important;min-height:0!important;padding:40px 6px 42px!important;
  ...
  #vw-home-v2-root .vw2-right{
    grid-column:3!important;grid-row:1!important;height:100%!important;min-height:0!important;
...
@media (max-width:720px) and (orientation:landscape) and (max-height:650px){
  ...
  #vw-home-v2-root .vw2-main-grid{grid-template-columns:68px minmax(0,1fr) 145px!important}
