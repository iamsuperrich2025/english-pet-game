...
/* === Home V2 Mobile Landscape Emergency Correction Pass ===
   Fixes fixed-height/grid-track compression at phone landscape sizes.
   Presentation only: authoritative Classic Lobby action routing remains unchanged. */
@media (max-width:1100px) and (orientation:landscape){
  ...
  #vw-home-v2-root .vw2-shell{
    ...
    grid-template-rows:auto auto auto auto!important;align-content:start!important;
    gap:6px!important;padding:6px!important;overflow:visible!important;
  }
  #vw-home-v2-root .vw2-shell:after{left:0!important;right:0!important}

  #vw-home-v2-root .vw2-top{
    grid-row:1!important;display:grid!important;
    grid-template-columns:minmax(188px,29%) minmax(0,1fr)!important;
    grid-template-rows:58px 48px!important;gap:6px!important;
    width:100%!important;min-width:0!important;max-width:100%!important;align-items:stretch!important;
  }
  #vw-home-v2-root .vw2-profile{
    grid-column:1!important;grid-row:1!important;min-width:0!important;min-height:58px!important;height:58px!important;
    padding:5px 8px!important;gap:7px!important;border-radius:20px!important;
  }
  #vw-home-v2-root .vw2-avatar{width:46px!important;height:46px!important;flex:0 0 46px!important;border-width:3px!important;border-radius:16px!important}
  #vw-home-v2-root .vw2-avatar .vw2-icon{width:36px!important;height:36px!important}
  #vw-home-v2-root .vw2-name-row strong{font-size:13.5px!important;line-height:1.1!important}
  #vw-home-v2-root .vw2-pencil .vw2-icon{width:17px!important;height:17px!important}
  #vw-home-v2-root .vw2-id{font-size:7.6px!important;padding:1px 6px!important;margin-top:1px!important}
  #vw-home-v2-root .vw2-profile .vw2-minirow{font-size:8px!important;line-height:1.12!important;margin-top:2px!important;white-space:nowrap!important}
  #vw-home-v2-root .vw2-profile-chips{margin-top:2px!important;gap:3px!important;flex-wrap:nowrap!important}
  #vw-home-v2-root .vw2-rank{font-size:7.7px!important;padding:2px 6px!important;white-space:nowrap!important}
  #vw-home-v2-root .vw2-sync-chip{font-size:7px!important;padding:2px 5px!important;max-width:88px!important}

  #vw-home-v2-root .vw2-wallet{
    grid-column:2!important;grid-row:1!important;display:grid!important;
    grid-template-columns:1.22fr repeat(4,minmax(0,1fr))!important;grid-template-rows:58px!important;
    grid-auto-rows:58px!important;gap:4px!important;align-content:stretch!important;min-width:0!important;
  }
  #vw-home-v2-root .vw2-wallet-pill{
    ...
    height:58px!important;min-height:58px!important;padding:3px 5px!important;border-width:3px!important;border-radius:18px!important;
  }
  #vw-home-v2-root .vw2-wallet-pill.coin{
    grid-column:auto!important;grid-row:auto!important;height:58px!important;min-height:58px!important;
    grid-template-columns:25px minmax(0,1fr) 15px!important;grid-template-rows:15px 24px!important;column-gap:2px!important;
  }
  #vw-home-v2-root .vw2-wallet-pill.coin .vw2-icon{width:25px!important;height:25px!important}
  #vw-home-v2-root .vw2-wallet-pill.coin em{width:15px!important;height:15px!important;font-size:8px!important;border-width:1px!important}
  #vw-home-v2-root .vw2-wallet-pill.worth{display:flex!important}
  #vw-home-v2-root .vw2-wallet-pill small{font-size:7.7px!important;line-height:1.08!important;white-space:normal!important;text-align:center!important}
  #vw-home-v2-root .vw2-wallet-pill b,#vw-home-v2-root .vw2-wallet-pill.coin b{font-size:12.5px!important;line-height:1.08!important;max-width:100%;overflow:hidden;text-overflow:ellipsis}
  #vw-home-v2-root .vw2-wallet-pill .vw2-pill-status{font-size:6.8px!important;line-height:1.08!important;white-space:normal!important;text-align:center!important;overflow:visible!important}

  #vw-home-v2-root .vw2-top-actions{
    grid-column:1/-1!important;grid-row:2!important;display:grid!important;
    grid-template-columns:repeat(7,minmax(0,1fr))!important;grid-template-rows:48px!important;grid-auto-rows:48px!important;
    gap:5px!important;align-content:stretch!important;justify-content:stretch!important;min-width:0!important;
  }
  #vw-home-v2-root .vw2-top-actions .vw2-tool-btn,#vw-home-v2-root .vw2-top-actions .vw2-classic{
    ...
    padding:3px 4px!important;border-width:3px!important;border-radius:15px!important;
    display:grid!important;grid-template-columns:26px minmax(0,1fr)!important;grid-template-rows:1fr!important;
    align-items:center!important;justify-items:center!important;gap:3px!important;
  }
  #vw-home-v2-root .vw2-top-actions .vw2-tool-btn .vw2-icon,#vw-home-v2-root .vw2-top-actions .vw2-classic .vw2-icon{width:25px!important;height:25px!important;flex:0 0 25px!important;margin:0!important}
  #vw-home-v2-root .vw2-top-actions .vw2-tool-btn b{font-size:8.6px!important;line-height:1.12!important;white-space:normal!important;text-align:center!important;word-break:keep-all!important}

  #vw-home-v2-root .vw2-preview-mark{
    grid-row:2!important;position:static!important;justify-self:center!important;align-self:center!important;
    max-width:calc(100% - 12px)!important;margin:0!important;padding:2px 9px!important;
    font-size:7px!important;line-height:1.15!important;letter-spacing:.035em!important;
  }

  #vw-home-v2-root .vw2-main-grid{
    grid-row:3!important;display:grid!important;grid-template-columns:repeat(12,minmax(0,1fr))!important;
    ...
    min-height:0!important;height:auto!important;align-items:start!important;overflow:visible!important;
  }
  #vw-home-v2-root .vw2-main-grid>*{min-width:0!important;max-width:100%!important;width:100%!important}

  #vw-home-v2-root .vw2-feature{
    grid-column:1/-1!important;grid-row:1!important;min-height:clamp(380px,48vw,440px)!important;height:auto!important;
    padding:55px 8px 56px!important;border-radius:25px!important;
  }
  #vw-home-v2-root .vw2-feature-title{
    left:17%!important;right:17%!important;top:5px!important;height:42px!important;
    font-size:15px!important;border-width:3px!important;border-radius:19px!important;padding:0 8px!important;
  }
  #vw-home-v2-root .vw2-feature-title .vw2-icon{width:19px!important;height:19px!important}
  #vw-home-v2-root .vw2-word-ribbon{top:53px!important;left:9px!important;right:9px!important;height:33px!important;padding:0 58px 0 10px!important;font-size:9.5px!important;border-width:2px!important}
  #vw-home-v2-root .vw2-word-ribbon:after{right:8px!important;top:4px!important;height:21px!important;min-width:40px!important}
  #vw-home-v2-root .vw2-feature-stage{top:92px!important;bottom:59px!important;left:8px!important;right:8px!important;border-width:3px!important;border-radius:21px!important}
  #vw-home-v2-root .vw2-speech{left:3%!important;top:5%!important;width:min(35%,205px)!important;padding:8px 10px 9px!important;border-width:3px!important;font-size:10px!important;line-height:1.3!important}
  #vw-home-v2-root .vw2-speech small{font-size:8px!important;line-height:1.3!important;margin-top:3px!important}
  #vw-home-v2-root .vw2-rainbow{left:2%!important;top:17%!important;width:50%!important}
  #vw-home-v2-root .vw2-castle{right:0!important;top:12%!important;width:38%!important}
  #vw-home-v2-root .vw2-pet{width:clamp(145px,20vw,185px)!important;height:clamp(145px,20vw,185px)!important;top:53%!important}
  #vw-home-v2-root .vw2-pet-halo{width:clamp(165px,23vw,210px)!important;height:clamp(165px,23vw,210px)!important;top:53%!important}
  #vw-home-v2-root .vw2-pet-platform{width:clamp(180px,24vw,220px)!important;height:64px!important;bottom:46px!important;border-width:5px!important}
  #vw-home-v2-root .vw2-pet-sparkles{width:clamp(190px,26vw,235px)!important;height:clamp(160px,23vw,205px)!important;top:51%!important}
  #vw-home-v2-root .vw2-player-mini{left:3%!important;bottom:63px!important;width:54px!important;height:65px!important;border-width:3px!important;border-radius:18px!important}
  #vw-home-v2-root .vw2-reward-card{right:3%!important;bottom:63px!important;width:108px!important;padding:5px!important;border-width:3px!important;grid-template-columns:28px minmax(0,1fr)!important}
  #vw-home-v2-root .vw2-reward-card .vw2-icon{width:28px!important;height:28px!important}
  #vw-home-v2-root .vw2-reward-card b{font-size:7.5px!important}#vw-home-v2-root .vw2-reward-card small{font-size:6.5px!important}
  #vw-home-v2-root .vw2-stage-copy{bottom:5px!important;width:min(54%,335px)!important;max-width:335px!important;padding:6px 9px!important;border-width:2px!important}
  #vw-home-v2-root .vw2-stage-copy b{font-size:10.4px!important}#vw-home-v2-root .vw2-stage-copy span{font-size:8.2px!important;line-height:1.25!important}
  #vw-home-v2-root .vw2-feature-actions{left:8px!important;right:8px!important;bottom:7px!important;height:44px!important;gap:6px!important}
  #vw-home-v2-root .vw2-feature-actions button{min-height:44px!important;height:44px!important;padding:3px 7px!important;border-width:3px!important;border-radius:15px!important;font-size:10.5px!important}
  #vw-home-v2-root .vw2-feature-actions .vw2-icon{width:24px!important;height:24px!important}

  #vw-home-v2-root .vw2-left{
    grid-column:1/-1!important;grid-row:2!important;display:grid!important;
    grid-template-columns:repeat(3,minmax(0,1fr))!important;grid-auto-rows:auto!important;
    padding:7px!important;gap:6px!important;overflow:visible!important;border-radius:22px!important;
  }
  #vw-home-v2-root .vw2-left .vw2-rail-btn{
    min-width:0!important;width:100%!important;min-height:50px!important;
    grid-template-columns:30px minmax(0,1fr)!important;column-gap:7px!important;
    padding:5px 7px!important;border-radius:15px!important;align-items:center!important;justify-items:start!important;
  }
  #vw-home-v2-root .vw2-left .vw2-rail-btn>span,#vw-home-v2-root .vw2-left .vw2-rail-btn .vw2-icon{width:30px!important;height:30px!important}
  #vw-home-v2-root .vw2-left .vw2-rail-btn b,#vw-home-v2-root .vw2-left .vw2-rail-btn[data-vw2-action="cannon"] b{font-size:10px!important;line-height:1.2!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;text-align:left!important;word-break:keep-all!important}

  #vw-home-v2-root .vw2-feed{grid-column:1/7!important;grid-row:3!important;height:auto!important;min-height:0!important;overflow:visible!important;padding:9px!important;border-radius:21px!important}
  #vw-home-v2-root .vw2-right{grid-column:7/-1!important;grid-row:3!important;grid-template-columns:minmax(0,1fr)!important;grid-template-rows:auto auto!important;gap:7px!important;height:auto!important;min-height:0!important}
  #vw-home-v2-root .vw2-mission,#vw-home-v2-root .vw2-online{height:auto!important;min-height:0!important;overflow:visible!important;padding:9px!important;border-radius:21px!important}
  #vw-home-v2-root .vw2-section-head{min-height:36px!important;gap:6px!important}
  #vw-home-v2-root .vw2-section-head>.vw2-head-icon{width:32px!important;height:32px!important;border-radius:12px!important}
  #vw-home-v2-root .vw2-section-head>.vw2-head-icon .vw2-icon{width:26px!important;height:26px!important}
  #vw-home-v2-root .vw2-section-head strong{font-size:12px!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important}
  #vw-home-v2-root .vw2-section-head>button{min-height:32px!important;padding:5px 8px!important;font-size:8.8px!important}
  #vw-home-v2-root .vw2-section-head>b{font-size:9px!important;padding:4px 7px!important}
  #vw-home-v2-root .vw2-feed-card{grid-template-columns:38px minmax(0,1fr)!important;gap:7px!important;margin-top:6px!important;padding:8px!important}
  #vw-home-v2-root .vw2-feed-avatar{width:38px!important;height:38px!important}#vw-home-v2-root .vw2-feed-avatar .vw2-icon{width:31px!important;height:31px!important}
  #vw-home-v2-root .vw2-feed-card b{font-size:10.5px!important}#vw-home-v2-root .vw2-feed-card p{font-size:9.8px!important;line-height:1.4!important;-webkit-line-clamp:4!important}
  #vw-home-v2-root .vw2-feed-stats{margin-top:7px!important;gap:5px!important;flex-wrap:nowrap!important}
  #vw-home-v2-root .vw2-feed-stats span{min-height:34px!important;padding:5px!important;font-size:8.8px!important}
  #vw-home-v2-root .vw2-feed-coin{min-height:38px!important;margin-top:6px!important;padding:6px 8px!important;font-size:9px!important}
  #vw-home-v2-root .vw2-quest-row{min-height:46px!important;grid-template-columns:34px minmax(0,1fr) auto!important;gap:6px!important;padding:6px 7px!important}
  #vw-home-v2-root .vw2-qemoji{width:34px!important;height:34px!important}#vw-home-v2-root .vw2-qbody b{font-size:9.7px!important}#vw-home-v2-root .vw2-qscore{font-size:8.5px!important}
  #vw-home-v2-root .vw2-online-card{grid-template-columns:10px minmax(0,1fr) 32px!important;gap:6px!important;padding:7px!important}
  #vw-home-v2-root .vw2-online-card b{font-size:10px!important;line-height:1.25!important}#vw-home-v2-root .vw2-online-card small{font-size:8.8px!important;line-height:1.25!important}
  #vw-home-v2-root .vw2-friends-btn{min-height:42px!important;margin-top:7px!important;font-size:9.7px!important}

  #vw-home-v2-root .vw2-bottom{
    grid-row:4!important;display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;
    grid-template-rows:none!important;grid-auto-flow:row!important;grid-auto-columns:auto!important;grid-auto-rows:auto!important;
    width:100%!important;min-width:0!important;max-width:100%!important;gap:6px!important;padding:0 0 5px!important;overflow:visible!important;
  }
  #vw-home-v2-root .vw2-bottom .vw2-mode{width:100%!important;min-width:0!important;height:52px!important;min-height:52px!important;padding:5px 7px!important;border-width:3px!important;border-radius:16px!important;gap:5px!important}
  #vw-home-v2-root .vw2-bottom .vw2-mode .vw2-icon{width:27px!important;height:27px!important}
  #vw-home-v2-root .vw2-bottom .vw2-mode b{font-size:10px!important;line-height:1.16!important;white-space:normal!important;overflow:visible!important;text-overflow:clip!important;word-break:keep-all!important}
}

@media (max-width:720px) and (orientation:landscape){
  #vw-home-v2-root .vw2-top{grid-template-columns:minmax(0,1fr)!important;grid-template-rows:58px 58px 48px!important}
  #vw-home-v2-root .vw2-profile{grid-column:1!important;grid-row:1!important}
  #vw-home-v2-root .vw2-wallet{grid-column:1!important;grid-row:2!important;grid-template-columns:1.25fr repeat(4,minmax(0,1fr))!important}
  #vw-home-v2-root .vw2-top-actions{grid-column:1!important;grid-row:3!important}
  #vw-home-v2-root .vw2-name-row strong{font-size:12.5px!important}
  #vw-home-v2-root .vw2-wallet-pill small{font-size:7.1px!important}
  #vw-home-v2-root .vw2-wallet-pill b,#vw-home-v2-root .vw2-wallet-pill.coin b{font-size:11.5px!important}
  #vw-home-v2-root .vw2-wallet-pill .vw2-pill-status{font-size:6.3px!important}
  #vw-home-v2-root .vw2-top-actions .vw2-tool-btn,#vw-home-v2-root .vw2-top-actions .vw2-classic{grid-template-columns:22px minmax(0,1fr)!important;padding:3px!important}
  #vw-home-v2-root .vw2-top-actions .vw2-tool-btn .vw2-icon,#vw-home-v2-root .vw2-top-actions .vw2-classic .vw2-icon{width:22px!important;height:22px!important;flex-basis:22px!important}
  #vw-home-v2-root .vw2-top-actions .vw2-tool-btn b{font-size:8px!important}
  #vw-home-v2-root .vw2-feature{min-height:380px!important}
  #vw-home-v2-root .vw2-speech{width:min(36%,190px)!important;font-size:9.5px!important}
  #vw-home-v2-root .vw2-speech small{font-size:7.6px!important}
  #vw-home-v2-root .vw2-feed{grid-column:1/-1!important;grid-row:3!important}
  #vw-home-v2-root .vw2-right{grid-column:1/-1!important;grid-row:4!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;grid-template-rows:auto!important}
}
