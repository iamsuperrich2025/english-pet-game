...
/* ============================================================
   ...
   Vocab World Home V2 — Admin Preview (R11.3 Direct Fidelity Correction + Readability Recovery)
...
(function(){
  ...
  function ensureVisualStyles(){
    ...
    style.textContent = '#vw-home-v2-root{--vw2-r111-runtime-ready:1;--vw2-r112-runtime-ready:1;--vw2-r113-runtime-ready:1}';
  ...
  function build(){
    ...
    root.innerHTML = `
      ...
      <div class="vw2-shell">
        ...
        <div class="vw2-preview-mark">ADMIN PREVIEW · R11.3 DIRECT FIDELITY + READABILITY</div>
