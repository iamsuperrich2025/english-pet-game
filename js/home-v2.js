...
/* ============================================================
   ...
   Vocab World Home V2 — Admin Preview (Visual Master Fidelity Pass)
...
`;
    ...
    root.innerHTML = `
      ...
      <div class="vw2-shell">
        <header class="vw2-top">
          ...
          <section class="vw2-top-actions" aria-label="เครื่องมือ">
            ...
            <button data-vw2-action="logout" title="ออกจากระบบ">${icon('logout')}</button>
        ...
        <div class="vw2-main-grid">
          ...
          <main class="vw2-feature">
            ...
            <div class="vw2-feature-stage">
              ...
              <div class="vw2-speech">มังกรน้อยแห่ง Vocab World พร้อมออกผจญภัย!<small>ฝึกคำศัพท์และเก็บดาวไปด้วยกัน</small></div>
        ...
        <div class="vw2-preview-mark">ADMIN PREVIEW · HOME V2 MASTER FIDELITY PASS</div>
      </div>`;
  ...
  function sync(){
    ...
    copyImage('#pet-card .hero-scene .pet-img, #pet-card .pet-img, #pet-card .hero-scene img, #pet-card img','vw2-pet',mascotDragon());
