...
const GUN_POS=[.19,-.12,-.78];      // ตำแหน่งปืนเทียบกล้อง (x ขวา · y ล่าง · z ระยะหน้ากล้อง)
...
const GUN_ROT=[.002,.004,.09];      // มุมปืน: [ก้ม-เงย, หันเข้าใน, เอียงทแยง] — ลำกล้องชี้เข้ากากบาทพอดี
const GUN_SCALE=.57;                // ขนาดปืนในจอ (รอบ 453: ย่อลงให้เห็นทั้งกระบอกในเฟรม)
