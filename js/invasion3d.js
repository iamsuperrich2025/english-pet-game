...
const GUN_VIEW={
  ...
  r93:   {p:[0.209,-0.124,-0.964],  r:[-0.558,0.008,0.085], s:1.485},
...
const AIM_OFF=[0,-.274];  /* รอบ 488: ผู้ใช้ขีดเส้นแดงตามแนวลำกล้อง R93 — "ขยับจุดกึ่งกลางเป้าไปอยู่บนแนวเส้น"
                             ยกจุดเล็ง 73% → **63.7% ของจอ** = ค่า `gunSil().yAtX0` ของ R93 หลังจูนรอบ 487 (−0.274)
                             ✅ ใช้ได้กับไรเฟิลด้วย — แนวลำกล้องไรเฟิลตัดแกนกลางจอที่ −0.249 (ห่างกันแค่ 1.2% ของจอ)
                             (เดิม รอบ 460 = −0.46 · ค่าเก่ากว่านั้น 80% ของจอ) */
