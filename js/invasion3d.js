...
const GUN_POS=[.26,-.20,-.66];      // ตำแหน่งปืนเทียบกล้อง (x ขวา · y ล่าง · z ระยะหน้ากล้อง)
...
const GUN_ROT=[-.538,.004,.09];     // มุมปืน: [ก้ม-เงย, หันเข้าใน, เอียงทแยง] — รอบ 455: เงาปืนบนจอ 10° (ยกท้ายจาก 15°)
const GUN_SCALE=1.15;               // ขนาดปืนในจอ (รอบ 455: .85 → 1.15 · เทียบเดิมรอบ 453 ใหญ่ขึ้น 2 เท่า)
