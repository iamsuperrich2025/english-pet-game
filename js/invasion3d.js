...
const ADS_SCALE=1.32;                   // ขยับเข้าใกล้ตาอีกนิด (ให้รู้สึกมีมวล) — ต้องมากกว่า GUN_SCALE เสมอ ไม่งั้นยกปืนแล้วปืนหดเล็กลง
...
const GUN_POS=[.34,-.34,-.58];      // ตำแหน่งปืนเทียบกล้อง (x ขวา · y ล่าง · z ระยะหน้ากล้อง)
const GUN_ROT=[.04,.18,.16];        // มุมปืน: [ก้ม-เงย, หันซ้าย-ขวา, "เอียงทแยง"(roll)]
const GUN_SCALE=1.15;               // ขนาดปืนในจอ (441→442: .78 → 1.15 ผู้ใช้ขอ "ยาวและใหญ่กว่านี้")
