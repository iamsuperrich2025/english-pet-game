...
const GUN_POS=[.22,-.16,-.58];      // ตำแหน่งปืนเทียบกล้อง (x ขวา · y ล่าง · z ระยะหน้ากล้อง)
...
const GUN_ROT=[-.52,.004,.09];      // มุมปืน: [ก้ม-เงย, หันเข้าใน, เอียงทแยง] — รอบ 454: กดปากกระบอกลง 30° = เงาปืนบนจอ 15°
const GUN_SCALE=.85;                // ขนาดปืนในจอ (รอบ 454: ใหญ่ขึ้น 1.5 เท่าจาก .57)
