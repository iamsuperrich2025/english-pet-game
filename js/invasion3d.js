...
const ADS_POS=[0,-0.10,-0.60];          // ท่าแนบไหล่: ปืนเข้ากลางจอ พานท้ายชิดไหล่ (445: ดันไปหน้าอีกนิด ไม่ให้ท้ายปืนหลุดหลังกล้อง)
const ADS_ROT=[0.02,0,0];               // เลิกเอียงทแยง จัดลำกล้องให้ตรงแนวสายตา
const ADS_SCALE=.80;                    // ขยับเข้าใกล้ตาอีกนิด (ให้รู้สึกมีมวล) — ต้องมากกว่า GUN_SCALE เสมอ ไม่งั้นยกปืนแล้วปืนหดเล็กลง
...
const GUN_POS=[.22,-.18,-.62];      // ตำแหน่งปืนเทียบกล้อง (x ขวา · y ล่าง · z ระยะหน้ากล้อง)
const GUN_ROT=[.02,.07,.13];        // มุมปืน: [ก้ม-เงย, หันซ้าย-ขวา, "เอียงทแยง"(roll)]
const GUN_SCALE=.68;                // ขนาดปืนในจอ — ค่าที่ทำให้ "ทั้งกระบอกอยู่หน้ากล้อง" พอดี
