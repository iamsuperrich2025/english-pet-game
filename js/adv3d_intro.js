...
window.ADV3D_INTRO={
  ...
  drone:{
    goal:'บินเร็วสุดๆ ลอด <b>หน้าต่างตึกร้าง</b> เข้าไปในห้อง · ในแต่ละรอบมีเฉพาะตัวอักษรของ<b>คำปัจจุบัน</b> และต้องเก็บ<b>ตามลำดับจากซ้ายไปขวา</b> · บินเฉียดเก็บได้เลย ไม่ต้องจอด! · ตัวละ 1🪙 ครบคำ +50🪙 · เฉียดกำแพงไม่ชน = โบนัส 💨',
    ...
    keys:[['⌨️','<b>W/S</b> หน้า-ถอย · <b>A/D</b> เอียงข้าง'],
          ...
          ['🔄','<b>Q/E</b> = หันหัว · บินเฉียดเก็บตัวอักษรตามลำดับ']],
  },
  drive:{
