...
window.ADV3D_INTRO={
  ...
  haunt:{
    goal:'เก็บคำศัพท์ให้ครบ <b>5 คำ</b> ในโรงแรมผีสิงโดยไม่ Game Over · ภารกิจพิเศษนับเฉพาะคำที่คุณเก็บ<b>ตัวอักษรสุดท้าย</b>ด้วยตัวเอง คำของเพื่อนไม่นับ · สำเร็จรับ <b>10,000🪙</b> ทันที · ถูกผีโจมตีครบ 10 ครั้ง ภารกิจส่วนตัวเริ่มใหม่ที่ 0/5',
    touch:[['🕹️','ลากนิ้วครึ่งจอ <b>ซ้าย</b> = เดิน · ครึ่ง<b>ขวา</b> = หันมอง'],
           ...
           ['👻','หลังไฟดับ ผีจะตามผู้เล่นที่ใกล้ที่สุด · ถูกโจมตีครบ <b>10 ครั้ง = Game Over</b>']],
