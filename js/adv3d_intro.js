...
window.ADV3D_INTRO={
  ...
  haunt:{
    goal:'เดินเข้า <b>โรงแรมผีสิง 5 ชั้น</b> เก็บ<b>ตัวอักษรที่ซ่อนตามห้องพัก</b> มาต่อเป็นคำ · ขึ้นชั้นบนด้วย 🛗 <b>ลิฟต์</b> หรือ 🪜 <b>บันได</b> · อยู่ครบ <b>2 นาที ไฟทั้งโรงแรมจะดับ</b> ต้องใช้ 🔦 <b>ไฟฉาย</b> เดินต่อ · 👻 <b>ผีที่นี่ไม่ทำร้ายใครเลย</b> แค่โผล่มาหลอกให้ตกใจ · 🧑‍🤝‍🧑 <b>เข้าคนเดียวได้เลยไม่ต้องรอใคร</b> — โรงแรมหลังหนึ่งอยู่ด้วยกันได้ไม่เกิน 2 คน',
    touch:[['🕹️','ลากนิ้วครึ่งจอ <b>ซ้าย</b> = เดิน · ครึ่ง<b>ขวา</b> = หันมอง'],
           ...
           ['👻','ผีไม่ทำร้ายเรา — เดินเข้าไปหาได้ มันจะหายไปเอง']],
    keys:[['🖱️','คลิกจอ 1 ครั้ง = ล็อกเมาส์ · <b>WASD</b> = เดิน'],
          ...
          ['👻','ผีไม่ทำร้ายเรา ไม่มีหัวใจ ไม่มีเกมโอเวอร์ — เก็บคำอย่างเดียว']],
  },
  heli:{
