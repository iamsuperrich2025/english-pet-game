...
/* ============================================================
   ...
   - คำศัพท์อังกฤษกลางจอด้านบน + คำแปลไทยใต้คำ · พิมพ์ครบ 1 คำ = 🪙 100 เหรียญ + เสียงเงินเข้า
   ...
   ============================================================ */
(function(){
  const COIN_PER_WORD = 100;            // 🪙 ผู้ใช้สั่งรอบ 1598: รางวัลพิมพ์ครบคำ 10 -> 100 เหรียญ
  ...
  /* ✅ พิมพ์ครบคำ → 🪙 100 เหรียญ + เหรียญสะสมกระดาน + เสียงเงินเข้าชัด ๆ + ลงสมุดคำศัพท์ + กันคำซ้ำ */
  function finishWord(){
    locked=true;
