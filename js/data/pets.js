...
/* ข้อ 5.1 เก็บข้อมูลอาหารคนเดิมไว้รองรับเซฟเก่าเท่านั้น:
   เมนูให้อาหารสัตว์และร้าน Paws & Pantry ต้องกรอง human/badFor ออกทั้งหมด
   ห้ามเสนออาหารที่เป็นโทษแม้สัตว์บางชนิดจะเคยถูกตั้งค่าให้กินได้ */
const FOODS = [
...
/* กฎกลางของทุกหน้าร้าน/เมนูสัตว์: แสดงเฉพาะอาหารสัตว์ที่ปลอดภัยกับทุกชนิด */
function foodSafeForPetMenu(food){
  return !!food && !food.human && !(Array.isArray(food.badFor)&&food.badFor.length);
}
