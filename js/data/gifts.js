...
const GIFTS = [
  /* ---- 🎂 เค้ก 22 แบบ ---- */
  {id:'cake_dino',      emoji:'🦕', name:'เค้กไดโนเสาร์',            cat:'cake', price:3000},
  {id:'cake_unicorn',   emoji:'🦄', name:'เค้กยูนิคอร์น',           cat:'cake', price:3000},
  {id:'cake_rainbow',   emoji:'🌈', name:'เค้กสายรุ้งวันเกิด',       cat:'cake', price:3000},
  {id:'cake_puppy',     emoji:'🐶', name:'เค้กหน้าหมาน้อย',          cat:'cake', price:3000},
  {id:'cake_kitten',    emoji:'🐱', name:'เค้กหน้าแมวเหมียว',        cat:'cake', price:3000},
  {id:'cake_rocket',    emoji:'🚀', name:'เค้กจรวดอวกาศ',           cat:'cake', price:3000},
  {id:'cake_princess',  emoji:'🏰', name:'เค้กปราสาทเจ้าหญิง',       cat:'cake', price:3000},
  {id:'cake_racecar',   emoji:'🏎️', name:'เค้กรถแข่ง',              cat:'cake', price:3000},
  ...
  {id:'cake_orchid',    emoji:'🌸', name:'เค้กกล้วยไม้',            cat:'cake', price:5000},
  {id:'cake_gold',      emoji:'🥇', name:'เค้กทองคำเปลว',           cat:'cake', price:5000},
  {id:'cake_marble',    emoji:'🎂', name:'เค้กหินอ่อนหรู',          cat:'cake', price:5000},
  {id:'cake_tiered',    emoji:'🎂', name:'เค้ก 3 ชั้นขาวทอง',       cat:'cake', price:5000},
  {id:'cake_pearl',     emoji:'🎂', name:'เค้กไข่มุกหรู',           cat:'cake', price:5000},
