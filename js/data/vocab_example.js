...
const VOCAB_BANDS = [
  ...
  {band:2, grades:['ป.3','ป.4'], label:'ประถมกลาง (ป.3–ป.4)', cats:[
    {id:'b2_school', name:'ห้องเรียนของเรา', emoji:'📖', reward:100, words:[
    ...
    {id:'b2_days', name:'วันและเวลา', emoji:'📅', reward:100, words:[
    ...
    {id:'b2_weather', name:'อากาศและฤดูกาล', emoji:'⛅', reward:100, words:[
    ...
    {id:'b2_numbers', name:'ตัวเลขและจำนวน', emoji:'🔢', reward:100, words:[
    ...
    {id:'b2_fruits', name:'ผักและผลไม้', emoji:'🥕', reward:100, words:[
  ...
  {band:3, grades:['ป.5','ป.6'], label:'ประถมปลาย (ป.5–ป.6)', cats:[
    {id:'b3_jobs', name:'อาชีพ', emoji:'👮', reward:100, words:[
    ...
    {id:'b3_places', name:'สถานที่ในเมือง', emoji:'🏙️', reward:100, words:[
    ...
    {id:'b3_sports', name:'กีฬาและงานอดิเรก', emoji:'⚽', reward:100, words:[
    ...
    {id:'b3_health', name:'สุขภาพ', emoji:'🏥', reward:100, words:[
    ...
    {id:'b3_travel', name:'การเดินทาง', emoji:'✈️', reward:100, words:[
    ...
    {id:'b3_feelings', name:'ความรู้สึก', emoji:'😊', reward:100, words:[
    ...
    {id:'b3_house', name:'ในบ้านของเรา', emoji:'🛋️', reward:100, words:[
    ...
    {id:'b3_verbs2', name:'กริยาชวนคิด', emoji:'💭', reward:100, words:[
  ...
  {band:4, grades:['ม.1','ม.2','ม.3'], label:'มัธยมต้น (ม.1–ม.3)', cats:[
    {id:'b4_environment', name:'สิ่งแวดล้อม', emoji:'🌍', reward:100, words:[
    ...
    {id:'b4_technology', name:'เทคโนโลยี', emoji:'💻', reward:100, words:[
    ...
    {id:'b4_school2', name:'ชีวิตนักเรียน', emoji:'🎒', reward:100, words:[
    ...
    {id:'b4_adjectives', name:'คำคุณศัพท์', emoji:'✨', reward:100, words:[
    ...
    {id:'b4_verbs3', name:'กริยาระดับกลาง', emoji:'🚀', reward:100, words:[
    ...
    {id:'b4_society', name:'สังคมและชุมชน', emoji:'🏘️', reward:100, words:[
    ...
    {id:'b4_character', name:'อารมณ์และนิสัย', emoji:'🎭', reward:100, words:[
    ...
    {id:'b4_work', name:'โลกของงาน', emoji:'💼', reward:100, words:[
  ...
  {band:5, grades:['ม.4','ม.5','ม.6','ปริญญาตรี','สูงกว่าปริญญาตรี'], label:'มัธยมปลาย (ม.4–ม.6)', cats:[
    ...
    {id:'b5_abstract', name:'ความคิดเชิงลึก', emoji:'🧠', reward:100, words:[
    ...
    {id:'b5_economy', name:'เศรษฐกิจ', emoji:'📈', reward:100, words:[
    ...
    {id:'b5_science', name:'วิทยาศาสตร์ขั้นสูง', emoji:'🔬', reward:100, words:[
    ...
    {id:'b5_verbs4', name:'กริยาขั้นสูง', emoji:'⚡', reward:100, words:[
    ...
    {id:'b5_media', name:'สื่อและข่าวสาร', emoji:'📰', reward:100, words:[
    ...
    {id:'b5_character2', name:'บุคลิกภาพ', emoji:'🌟', reward:100, words:[
    ...
    {id:'b5_global', name:'โลกและอนาคต', emoji:'🌐', reward:100, words:[
