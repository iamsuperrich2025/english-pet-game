...
/* ============================================================
   ...
   แรงค์สูงสุด "จอมพล (Marshal)" ไม่มีขั้นย่อย
   ------------------------------------------------------------
...
const RANKS = [
  {id:'bronze',   name:'บรอนซ์',    en:'BRONZE',   emoji:'🥉', color:'#b07a4a', min:0},          // 0 – 9,999
  {id:'silver',   name:'ซิลเวอร์',  en:'SILVER',   emoji:'🥈', color:'#9aa5b5', min:10000},      // 10,000 – 199,999
  {id:'gold',     name:'โกลด์',     en:'GOLD',     emoji:'🥇', color:'#e0a92e', min:200000},     // 200,000 – 999,999
  {id:'platinum', name:'แพลตินัม',  en:'PLATINUM', emoji:'💠', color:'#5bc0de', min:1000000},    // 1,000,000 – 1,999,999
  {id:'diamond',  name:'ไดมอนด์',   en:'DIAMOND',  emoji:'💎', color:'#7d5fc0', min:2000000},    // 2,000,000 – 3,999,999
  {id:'master',   name:'มาสเตอร์',  en:'MASTER',   emoji:'🔱', color:'#e05b3a', min:4000000},    // 4,000,000 – 19,999,999
  {id:'marshal',  name:'จอมพล',     en:'MARSHAL',  emoji:'⭐', color:'#d4386f', min:20000000},   // ≥ 20,000,000
];
