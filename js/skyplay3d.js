...
(function(){
  ...
  function start(){if(running)return;ensureState();teacherData=loadTeacherData();fxLow=!!state.noAnim||(navigator.hardwareConcurrency&&navigator.hardwareConcurrency<=4);if(typeof clearWarnToasts==='function')clearWarnToasts();if(typeof Music!=='undefined')Music.suspendBg();createDom();initThree();running=true;paused=false;activity='plaza';activityRound=null;activityStartedAt=0;activityDone=false;routeFinished=false;sessionCoins=0;sessionStars=0;joinOffer=null;classOffer=null;classWire='';classFinished=false;classRoster={};classHostUid='';classReportSaved=false;setupOnline();updateHud();if(!restoreHostLesson()&&!restoreActiveRun())showToast('🎮 PLAY 4 กิจกรรม · 🏫 CLASS เปิด Lesson Packs และ Reports');lastFrame=0;raf=requestAnimationFrame(loop);}
