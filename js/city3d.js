"use strict";
/* ============================================================
   city3d.js — 🏙️ VOCAB CITY: ล็อบบี้ 3D แบบเมืองลอยฟ้า (หน้ารอง index.html?lobby=3d; หน้าเริ่มต้น = Lobby Classic)
   ------------------------------------------------------------
   ...
   · อาคาร 33 หลังผูกลิงก์จริงของเกม → แตะแล้วเด้งไป index_classic.html?go=<key>
