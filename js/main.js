...
(function(){
  ...
  const CLICK = {
    ...
    wordsearch:'#btn-rail-wordsearch', typing:'#btn-rail-typing', bubble:'#btn-rail-bubble', shootword:'#btn-rail-shootword', wordship:'#btn-rail-wordship', lettercannon:'#btn-rail-lettercannon', examstd:'#btn-rail-examstd', onet:'#btn-rail-onet',
