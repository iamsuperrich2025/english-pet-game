...
/* ============================================================
   🎫 คืนเงินตั๋วโลก 3D ราคาแพงจากระบบเก่า; ปัจจุบันทุกโลกเข้าเล่นฟรี
...
function showTicketRefund(){
  ...
  ov.innerHTML = `
    ...
    <div class="rankup-content qbp">
      ...
      <div class="rankup-name" style="color:#ffb300">+${num(b.total)} เหรียญ 🪙</div>
      <p class="rankup-sub">ยินดีด้วย ${escapeHTML(name)}! 🎉<br>
        ตั๋วเข้าโลกผจญภัย 3D ที่เคยซื้อไว้ทีเดียวจ่ายแพงถูกยกเลิกแล้ว และตอนนี้ <b>ทุกโลกเข้าเล่นฟรี ไม่มีการหักเหรียญ</b><br>
...
/* ============================================================
   🏙️ ทางเชื่อมจากเมือง 3D (หน้ารอง index.html?lobby=3d) — ?go=<key>
   แตะตึกในเมือง → มาลงหน้าเริ่มต้น (index_classic.html) พร้อม param → เปิดแผง/หน้า/โลก 3D นั้นให้เองหลังบูตถึงหน้า Lobby
   ครอบ try ทั้งก้อน + ไม่มี param = ไม่ทำอะไรเลย → ไม่กระทบการเล่นปกติของล็อบบี้เดิม
   ============================================================ */
(function(){
  let go = null;
  ...
  const CLICK = {
    ...
    wordsearch:'#btn-rail-wordsearch', typing:'#btn-rail-typing', bubble:'#btn-rail-bubble', shootword:'#btn-rail-shootword', wordship:'#btn-rail-wordship', skirmish:'#btn-rail-skirmish', vocabforce:'#btn-rail-vocabforce', lettercannon:'#btn-rail-lettercannon', examstd:'#btn-rail-examstd', onet:'#btn-rail-onet',
