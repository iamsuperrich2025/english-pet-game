...
/* ============================================================
   🏙️ รอบ 861: ทางเชื่อมจากเมือง 3D (index.html = หน้าหลัก ตั้งแต่รอบ 863) — ?go=<key>
   แตะตึกในเมือง → มาลงหน้านี้ (index_classic.html) พร้อม param → เปิดแผง/หน้า/โลก 3D นั้นให้เองหลังบูตถึงหน้า Lobby
