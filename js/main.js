...
(function(){
  ...
  const CLICK = {
    ...
    wordsearch:'#btn-rail-wordsearch', typing:'#btn-rail-typing', bubble:'#btn-rail-bubble', shootword:'#btn-rail-shootword', lettercannon:'#btn-rail-lettercannon', examstd:'#btn-rail-examstd',
