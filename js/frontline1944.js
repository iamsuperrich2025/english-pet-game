 ...
 * Phase 1.2.2 Visual Forward Vector Lock: canonical tank controller, streamed battlefield sectors, logical world coordinates,
...
const CFG={
  ...
  cameraHeight:86,
  cameraOffsetZ:72,
  runtimeVersion:'P1.2.2-20260831-DIRECTION-LOCK',
  sectorWidth:180,
  sectorLength:150,
  streamRadius:1,
  preloadAhead:2,
...
function claimTankRuntimeOwnership(){
  const identity={kind:'tank',phase:'1.2.2',version:CFG.runtimeVersion,sharedRuntime:true,active:true};G.runtimeIdentity=identity;
...
function runtimeIdentity(){return G.runtimeIdentity||{kind:'tank',phase:'1.2.2',version:CFG.runtimeVersion,sharedRuntime:true,active:false};}
...
function makeDom(){
  ...
  <div class="fl44-hud"><div class="fl44-top">
    ...
    <div class="fl44-panel fl44-coins"><span>เหรียญรวม</span><strong id="fl44-coins">0</strong><span id="fl44-grade"></span><small id="fl44-sector">Sector 0</small><small id="fl44-runtime">P1.2.2</small></div>
  </div>
