 ...
 * Phase 1.2.6G Immediate Floating AIM Recenter: accepted Phase 1.2.6 controls plus deterministic delivery identity, logical world coordinates,
...
const CFG={
  ...
  runtimeVersion:'P1.2.6G-20260903-AIM-FLOAT-IMMEDIATE',
...
class GlobalMobileTouchRouter{
  ...
  begin(id,x,y,target,transport){
    ...
    if(role==='drive'){this.recenter(role,x,y);this.driveState.id=id;this.applyStick(role,x,y,transport);}else if(role==='aim'){/* AIM is a floating stick like DRIVE: every new touch recenters the base immediately, so changing hand position never depends on a long-press gesture. Normal turret aim still starts on the same pointerdown and uses movement from this new center. */this.recenter(role,x,y);this.aimState.id=id;this.startAimGesture(id,x,y,transport,true);this.applyStick(role,x,y,transport);}else this.startFireGesture(id,x,y,transport);
