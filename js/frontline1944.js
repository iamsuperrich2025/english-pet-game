...
function activateNextFortress(initial){
  if(localTargetLockTestRangeEnabled())return activateLocalTargetLockTestRange();
...
function destroyCore(){
  ...
  if(f.testRange){
    ...
    setTimeout(()=>{if(G.running&&G.fortress===destroyed&&destroyed.state==='destroyed'&&localTargetLockTestRangeEnabled())activateLocalTargetLockTestRange();},620);updateHud();return;
  }
