...
function openHelp(){
  ...
  overlay.innerHTML = `<div class="levelup-box help-box">
    ...
    <div class="help-body">
      ...
      <div class="help-item"><b>🍚 ข้าวเย็นของหนู</b><br>คนก็ต้องกินข้าวเย็นตอน 18:00 เหมือนกัน! แตะปุ่ม 🍚 มุมขวาบน (มื้อละ 🪙200) ถ้าลืมกินจนเลย 20:00 จะป่วย ต้องจ่ายค่ารักษา 🪙1,000</div>
