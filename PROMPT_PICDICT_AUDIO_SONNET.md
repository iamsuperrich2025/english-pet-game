...
|---|---|---|---|---|
| — | — | ยังไม่เริ่ม | 1,025 | — |
| 1 | 4 ส.ค. 2026 | 1,617 (1,378 + 239 รันซ้ำ เพราะหนังสือโตจาก 1,306→2,064 คำระหว่างรัน) | 5 | 5 คำนี้ไม่ถูก `PAIR_RE` จับ (มีวงเล็บ/จุด เกินขอบเขตที่แก้ได้ในงานนี้): `Hand (back)`, `RV (Camper)`, `St. Patrick's Day`, `a.m.`, `p.m.` — ต้องแก้ regex ในสคริปต์ถึงจะครอบคลุม (ไม่ใช่ fail จากเน็ต/TTS) |
