...
<!-- AUTO-FILES:BEGIN -->
### 🤖 ไฟล์ไหนทำอะไร — เจนอัตโนมัติจาก comment หัวไฟล์ (`tools/gen_code_map.py` · **ห้ามแก้มือในบล็อกนี้**) · อัปเดต 2026-09-02
...
- **js/frontline1944.js** (1,828 บรรทัด) — Vocab World: Frontline 1944 — ADMIN PREVIEW ONLY · Phase 1.2.6 Movable FIRE + Global Double-Tap FIRE: canonical tank controller, streamed battlefield sectors, logical world coordinates, · lightweight terrain/collision, 2.5D occlusion anchors, tank runtime,
...
- **js/home-v2.js** (2,098 บรรทัด) — Vocab World Home V2 — Primary Lobby (R11.4 Visual Master Fidelity Reconstruction + Premium Depth / Composition Recovery) · R12 / รอบ 1279 — Ultimate Visual Master scenic + composition rebuild · R13 / รอบ 1280 — HUD, Bottom Rail and Left Navigation readability rebalance
...
- **js/lettercannon.js** (470 บรรทัด) — 🔤💥🏆 รางวัลรายเดือนของกระดาน Letter Cannon / Dragon Sky Siege
...
- **js/petpantry.js** (233 บรรทัด) — 🗄️ PET PANTRY — รอบ 1158 · ศูนย์กลาง mutation ของชั้น/stock/การซื้อหน้าร้าน 3D
...
- **js/ui.js** (10,328 บรรทัด) — UI: Dashboard / ร้านค้า / ที่พัก / ร้านสัตว์เลี้ยง / แรงค์ / สถิติ
...
- **css/frontline1944.css** (206 บรรทัด) — Vocab World: Frontline 1944 — ADMIN PREVIEW ONLY / Phase 1.2.6 Movable FIRE + Global Double-Tap FIRE + Accepted Canonical Tank Runtime
...
- **css/lettercannon.css** (88 บรรทัด) — 🐉💥 Dragon Sky Siege (รอบ 1312) · Portrait 9:16 vertical shooter HUD. Desktop centers the flight lane; · touch devices use the full portrait viewport.
