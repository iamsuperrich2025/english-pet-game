...
- **js/home-v2.js** (1,812 บรรทัด) — Vocab World Home V2 — Admin Preview (R11.4 Visual Master Fidelity Reconstruction + Premium Depth / Composition Recovery) · R12 / รอบ 1279 — Ultimate Visual Master scenic + composition rebuild · R13 / รอบ 1280 — HUD, Bottom Rail and Left Navigation readability rebalance
...
- **js/lettercannon.js** (284 บรรทัด) — 🔤💥 Letter Cannon — Word Siege (รอบ 1297) · Word Siege: defend the base, spell five words, survive the boss wave. · Wrong shots break streaks; missed key letters and meteors drain shields.
...
- **css/home-v2.css** (1,877 บรรทัด) — Vocab World Home V2 — R11.5.1 Safe Lightweight Asset Bridge Rebase · + Asset-Driven Visual Master Convergence / Premium Fantasy UI Refinement · ADMIN PREVIEW ONLY · R11.3 readability + authoritative handlers preserved
