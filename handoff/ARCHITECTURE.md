...
- **js/home-v2.js** (1,198 บรรทัด) — Vocab World Home V2 — Admin Preview (R11.4 Visual Master Fidelity Reconstruction + Premium Depth / Composition Recovery) · Additive UI shell only. It does NOT own economy, auth, quests, · Firebase, purchases, or game routing. Existing Lobby DOM stays
...
- **css/home-v2.css** (562 บรรทัด) — Vocab World Home V2 — R11.5.1 Safe Lightweight Asset Bridge Rebase · + Asset-Driven Visual Master Convergence / Premium Fantasy UI Refinement · ADMIN PREVIEW ONLY · R11.3 readability + authoritative handlers preserved
