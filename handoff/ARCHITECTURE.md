...
- **js/main.js** (195 บรรทัด) — ปุ่มหลัก + INIT
...
- **js/ui.js** (7,079 บรรทัด) — UI: Dashboard / ร้านค้า / ที่พัก / ร้านสัตว์เลี้ยง / แรงค์ / สถิติ
