...
- **js/main.js** (332 บรรทัด) — ปุ่มหลัก + INIT
...
- **js/util.js** (1,009 บรรทัด) — UTIL: เสียง / เอฟเฟกต์ / เครื่องมือทั่วไป
