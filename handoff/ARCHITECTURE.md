...
- **js/mecha-combat-fx.js** (277 บรรทัด) — Round 1513 — mecha projectiles. · Ballistic shells (Word Fleet gravity): Adventure3D owns physics via launch/sync/impact. · Impact FX: volumetric fireball + stacked shock rings (orange inner → white outer) · billow · smoke · debris · streaks ~1.5s.
