...
- **รอบ 1290 · Home V2 R22 (Admin Preview เท่านั้น):** เปลี่ยนแถบล่างจากแท็บข้อสอบเป็น Fantasy Adventure Dock 4 จุดหมาย—สมุดนักผจญภัย, สนามฝึกคำศัพท์, หอคอยท้าทาย และแผนที่โลก
- การเรียนเดิมครบ 13 action: สมุดเปิดตรง; เกมฝึก 5 รายการและข้อสอบ 7 รายการอยู่ใน flyout; แผนที่รวม 11 โลกและทุกปุ่มยัง delegate handler/source ของ Classic เดิม
- รักษางาน R21 “รักษาสัตว์ป่วยทั้งหมด” ที่ค้างอยู่: คิดราคารวม/เงินขาดแบบ atomic และใช้กฎรักษา Classic ร่วมกัน; ไม่แตะ `css/petshopping3d.css` เก่าของงานอื่น
- Admin gate ยังเป็น `isAdmin() === true`; syntax/regression R22 และ production build ผ่าน, ตรวจภาพ dock ที่ 812×375 กับ 1323×622 แล้วไม่ล้นแนวตั้ง
