...
- **🌀 งานจองไว้ (ผู้ใช้เคาะแล้ว 12 ก.ค. — เริ่มใน New session ตามกฎ token): เกม "วงแหวนสะกดคำ Spin-to-Spell" ใน Lobby**
  - **คอนเซ็ปต์:** ตัวอักษร 12–16 ตัวลอยเป็นวงแหวนรอบตัวน้อง 3D ในเวที lobby · เกมอ่านออกเสียงคำ (ไฟล์ `sound/words/` 400 คำมีแล้ว · `speakWord` util.js) · เด็ก**ปัดหมุนวงแหวน** (กลไก drag เดิมใน lobby3d.js — bindDrag/targetRot/spinVel มีโมเมนตัมแล้ว) ให้ตัวอักษรที่ต้องการมาตรงช่องเป้าด้านหน้า แตะเก็บ เรียงทีละตัวจนครบคำ → น้องเต้นฉลอง (clip Tripo) + เหรียญ
  - **เทคนิค:** วงแหวนตัวอักษร = sprite/plane text วางวงกลมรอบ petRoot ใน scene lobby3d (เพิ่ม group ใหม่หมุนแยกจาก spin ของตัวละคร) · ช่องเป้า = marker หน้ากล้อง · เข้าเกมจากปุ่มบนเวที g0 · คำจาก vocab ตามชั้นผู้เล่น (แบบ adventure3d) · ให้เหรียญ/คำ ~15-20 + ต่อ questEvent ev ใหม่ได้
  - **แบ่ง 2 รอบ:** (1) วงแหวน+หมุน+เก็บตัวอักษร+จบคำ (2) เสียงอ่าน/เอฟเฟกต์ฉลอง/รางวัล/ขัดเกลา+เทสต์จอเตี้ย
  - อ่านก่อนเริ่ม: lobby3d.js ทั้งไฟล์ (~350 บรรทัด) + กฎทองข้อ 7 (dialog/UI ต้องพอดีจอ 812×375)
