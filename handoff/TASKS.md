...
- **🌀 Spin-to-Spell รอบ 2 (ขัดเกลา — รอบแรกเสร็จแล้วรอบ 171 เล่นได้จริงบน live .162):**
  - **ทำต่อ:** (1) น้องเต้นฉลองตอนจบคำ (สลับ clip Tripo ชั่วคราว / กระโดดดีใจ) + เอฟเฟกต์ (คอนเฟตติ/แฟลชเวที) (2) โหมด "ฟังแล้วสะกด" — อ่านคำโจทย์ตอนขึ้นคำใหม่ + ปุ่ม 🔊 ฟังซ้ำ (`speakWord` มีแล้ว · ซ่อน/โชว์คำตามระดับ?ให้ผู้ใช้เคาะ) (3) questEvent ev ใหม่ 'spell' + เข้า pool ภารกิจวันนี้ (4) จูนฟีลมือถือจริงตาม feedback (ค่าใน lobby3d.js: `SP_R` รัศมีวง 1.05 · `SP_Y` ความสูง 0.55 · `SP_LS` ขนาดตัวอักษร 0.34 · `SPELL_COIN` 15)
  - รอบแรก (171) มีแล้ว: วงแหวน 12-16 ตัว+หมุน+snap+เก็บเรียงตัว+เสียงชื่อตัวอักษร+จบคำอ่านทั้งคำ+แบนเนอร์+🪙15+ขึ้นคำใหม่วน · จุดเข้า: ปุ่ม 🌀 บนเวที (g0+3D เท่านั้น)
