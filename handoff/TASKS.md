...
- syntax+regression+ข้อมูลจริง 8 หมวดใหญ่/1,099 set-cycle checks+production build 8,395 assets/PWA validator+source/dist hash ผ่าน (`tools/test_picmatch_page_cooldown.js`)
- **รอบ 1249 · จับคู่ภาพล็อกชุดแบบวนรอบรายหมวด:** เคลียร์ 1 รอบแล้วล็อกชุดนั้น; เล่นชุดอื่นในหมวดจนครบแล้วปลดล็อกทุกชุดพร้อมกันและเริ่มวงรอบใหม่ (`js/picmatch.js`)
- บันทึกเฉพาะตอนเคลียร์กระดาน ไม่ล็อกจากการกดเข้า/ออกกลางรอบ; แยกสถานะตามหมวดและขนาดชุด 4/10/20 จึงครอบคลุมทุกระดับชั้นและไม่ปะปนข้ามหมวด
- syntax+regression+46 หมวดจริง/1,099 set-cycle checks+production build 8,395 files/PWA validator+source/dist hash ผ่าน (`tools/test_picmatch_page_cooldown.js`)
- **รอบ 1248 · กระดานอันดับแสดงคนที่เหลือครบทุกหมวด:** แยกจำนวนแสดงเต็มจอเป็น Top 100 จากผู้รับรางวัล Top 10 ใน 🔎 ค้นหาคำ, 🖼️ จับคู่ภาพ, 🫧 ฟอง และ 🎯 ยิงเป้าคำ; อันดับ 11–100 แสดงต่อเนื่อง (`js/ui.js`)
- ทุกรายการยังเรียงคะแนนมาก→น้อยและเลื่อนดูในกล่องเดิม; อันดับเกิน 10 ไม่มีรางวัลเพิ่ม และแท็บอื่นไม่เปลี่ยนกติกา
- เพิ่ม regression ครบ display/prize/order; syntax+leaderboard/rank/award suite+production build 8,395 ไฟล์/PWA validator+bundle inspection ผ่าน; ซ่อม rank test ให้รองรับ CRLF บน Windows (`tools/test_leaderboard_scroll_rewards.js`, `tools/test_rank_move_feed.js`)
