...
### 🔜 งานถัดไปที่จองไว้: ระบบซื้อรถ + ประกัน + ไฟเลี้ยว (9 ข้อ · ผู้ใช้สั่ง 11 ก.ค.)
- **สเปกเต็ม + guideline สำหรับ session ใหม่:** Artifact https://claude.ai/code/artifact/4ef6bda9-b820-49c1-91d4-1f18617310d6 (ผู้ใช้จะวาง guideline เอง — ถ้า session ใหม่อ่านไฟล์นี้ก่อนได้ guideline ให้รอผู้ใช้วาง)
- สรุปย่อ: หมวด "🚗 ยานพาหนะ" ในตลาด (กริด 5/แถว · รถ 10 คัน img/cars/car_01..10.png — ผู้ใช้กำลังเจนจาก `PROMPTS_CARS.md`) · หน้าซื้อแจ้ง ราคารถ/พ.ร.บ./ประกัน · จ่ายสด+ผ่อนรายเดือน(ผูกระบบบิล)+โปะได้ · ปุ่มขับรถใน Lobby ล็อกกุญแจเหลืองจนกว่าซื้อรถ · ชนรถ peer = 5,000 (มีประกัน=ฟรี+ข้อความ "ประกันเป็นผู้จ่ายให้แล้ว") · ปุ่มไฟเลี้ยว+ตรวจแยก ม.36 ใบละ 100 · เพื่อนเห็นไฟเลี้ยว (field `tl` ใหม่ใน /world → **ต้อง publish rules**)
- ⚠️ ราคารถ/นโยบายผ่อนค้าง/คนมีตั๋วเดิมได้รถฟรีไหม → **ถามผู้ใช้เคาะก่อนเริ่ม**
