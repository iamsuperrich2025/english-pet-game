...
- 🏭 **[ค้าง — ผู้ใช้สั่ง 15 ก.ค. ทำหลังงานพื้นตะแกรงเสร็จ] ผลิตสินค้าเสร็จแล้วผู้เล่นหาไม่เจอว่าไปอยู่ไหน:**
  - **อาการ (ผู้เล่นจริงเจอเมื่อวาน):** ผลิตในโรงงานเสร็จ ไม่รู้สินค้าไปไหนต่อ
  - **ความจริง:** ผลิตเสร็จ → เข้า `state.collection` (`addCraft` [state.js:786]) แต่ UI ไม่บอกว่าไปดูที่ไหน
  - **แนวทาง:** ตอนฉากฉลอง "ผลิตสำเร็จ" (game.js:818 `showResult`) + toast → เพิ่มบอก "เก็บไว้ในคลัง/ตู้สะสม" + ปุ่มพาไปเปิดคลังเลย · หาว่าคลังสะสม (collection) เปิดจากตรงไหนในล็อบบี้ (panel ไหน) แล้วชี้ทางให้ชัด
  - **ยังไม่เริ่ม** — งานพื้นตะแกรง/ตำแหน่งแมว (รอบ 243, deploy .234) รอผู้ใช้ส่งภาพจูนอยู่ ทำอันนั้นให้จบก่อน
- 🐾 **สไปรต์น้องเดิน — ครบ 3 ตัวแล้ว (รอบ 241 · deploy .231):** แมวเดิน · หมาเดิน · มังกรยืนโยกตัว
