...
- **รอบ 1292 · ร้านชุดนักรบ:** เพิ่มเกราะ 10 แบบในตู้/ร้านแฟชั่น พร้อมภาพการ์ดใหญ่ แถบลากซ้าย–ขวา ปุ่มลองใส่ ภาพน้องตรงชนิด+วัย และ PIN ซื้อ 6 หลัก
- ตู้ Lobby กับร้านแฟชั่น 3D ใช้แคตตาล็อกเดียวกัน; ซื้อสำเร็จใส่ให้น้องทันที (ถ้ายังเป็นไข่เก็บเข้าตู้พร้อมป้ายบอก) และของเดิมที่มีแล้วกดใส่ได้
- ภาพนักรบ 180 ใบลงทะเบียน URL แบบ on-demand + `loading=lazy` ไม่ probe/download ตอน login; แก้ `items.js`, `images.js`, `petpantry.js`, `ui.js`, `css/petfashion.css` และ wiring/build/tests
- syntax + regression ร้าน/ภาพ/ตลาด + production build ผ่าน; browser automation ใช้ไม่ได้จาก sandbox ของเครื่องนี้ จึงคุม 812×375 ด้วย compact CSS + regression assertion แทน
