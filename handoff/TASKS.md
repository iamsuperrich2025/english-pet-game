...
- **รอบ 1288 · Home V2 R20 (Admin Preview เท่านั้น):** ย้าย “รักษา” เป็นปุ่มแรก; แถบคำสั่งใต้สัตว์เลื่อนได้ซ้าย–ขวาและใช้ปุ่มสมบูรณ์ 4 ปุ่ม—โปรไฟล์, ชื่อสัตว์/เปลี่ยนชื่อผ่าน Classic, สัตว์ที่ซื้อไว้ และร้านสัตว์
- เพิ่มหน้ารวมสัตว์ที่ซื้อไว้ ใช้ `state.pets/state.active` เดิม เลือกตัวเล่นได้จริง มีสถานะป่วย/กำลังเล่น ปุ่มปิดบน–ล่าง และรายการเลื่อนโดยซ่อน scrollbar
- แยก layout ตามจอ 5 กลุ่ม: compact 667×375, standard 740×400/915×412, wide 932×450, tablet 1024×600 และ desktop 1323×622; runtime ไม่มี page overflow/ข้อความตกขอบ และ rail ทั้งสองแนวเลื่อนได้โดยไม่มี vertical overflow
- โลกเฉพาะแอดมินยังคงตรง 6 โลกและทั้ง Home V2 ยัง gate ด้วย `isAdmin() === true`; regression, syntax, build/PWA validation ผ่านทั้งหมด
