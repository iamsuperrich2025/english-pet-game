...
- **รอบ 1416 · ยืนยันก่อนซื้อคลังธาตุ/อักษร:** กดการ์ดแล้วขึ้นกล่องหรู แสดงราคาและเหรียญคงเหลือ มีปุ่มยืนยัน/ยกเลิก ยกเลิกไม่หักเหรียญและคลังค้างไว้
- `js/arena3d.js` askBuy + `css/arena3d.css` · กด Esc/พื้นหลัง = ยกเลิก
- swipe 26/26 รวมซื้อ relic ท้ายแถวหลังยืนยัน · grimoire ยืนยัน/ยกเลิกเวทผ่าน
- ยังไม่ยืนยันบนมือถือจริงของผู้ใช้
