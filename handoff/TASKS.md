...
- **💬 3 ไอเดีย inbox (ผู้ใช้เคาะแล้ว — ยังไม่ทำ · ต่อยอดหน้ารวมข้อความรอบ 179 `openChatInbox` ใน ui.js):**
  1. เรียงแถวแชทตามข้อความล่าสุด (คนเพิ่งคุยขึ้นบนสุด แบบ Messenger) — ตอนนี้เรียงตาม myFriends · ต้องดึง ts ข้อความล่าสุด/คน (มี limitToLast 1 อยู่แล้ว) มา sort ก่อน render
  2. แถบ "กำลังออนไลน์" แนวนอนบนสุดของ inbox (วงกลมเพื่อนออนไลน์ เลื่อนข้างได้ แบบ story row)
  3. ปุ่มลัดชวนเล่นโลก 3D จาก inbox (ปุ่ม 🌍 ท้ายแถว → tinv เหมือน openFriendQuickMenu)
- **🚗 โลกขับรถ — งานค้าง/ต่อยอด (ผู้ใช้บอกยังมีต่อ):** ลองจริงมือถือรอบ 180-183 (เลนถนนกว้าง/เพลง+วิทยุ/เลนจักรยาน+ทางเท้า/ไฟเลี้ยวแยก/เสียงยาง/ไฟจราจร) แล้วให้ feedback · ไอเดียค้าง: รอยยางดำ skid marks · นับถอยหลังไฟแดง · ระบบขายป้ายโฆษณาในเกม (SHOP_ADS→DB) · เติมชื่อผู้ลงโฆษณาใน `SHOP_ADS` (adventure3d.js)
