...
### 🔜 งานค้างจากชุดระบบรถ 9 ข้อ: ข้อ 6–9 — กำลังทำต่อใน session เดียวกับรอบ 131
- ที่เหลือ: ชนรถ peer = 5,000 (มีประกัน=ฟรี+ข้อความ "🛡️ ประกันเป็นผู้จ่ายให้แล้ว") · ปุ่มไฟเลี้ยว ⬅️➡️ ใกล้ `#adv-steerpad` · ตรวจเลี้ยวที่แยกไม่เปิดไฟ ม.36 ใบละ 🪙100 · เพื่อนเห็นไฟเลี้ยว (field `tl` ใหม่ใน /world → **ต้อง publish rules** + fallback เขียนโดน deny ไม่พังเกม)
