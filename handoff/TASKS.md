...
- **⚠️ ค้างผู้ใช้:** ลองจริงมือถือ (login บัญชีจริงดูเหรียญ + ดูภาพ picker ในโลกขับรถ + โมเดลแมว/หมาไฟล์เล็กลงโหลดไวขึ้น) · ภาพ `car_blk1..8.png` (ตัวละครนั่งรถ รอบ 148) ยังไม่ได้เจน — picker ใช้ภาพยืน blk ครบแล้ว
