...
- 🔥 **สไปรต์วนลูปแทนโมเดล 3D ในล็อบบี้ (ผู้ใช้เสนอ 14 ก.ค. · กำลังทำ):** เลิกโหลด GLB+three.js ในล็อบบี้ → ใช้ **แผ่นสไปรต์พื้นหลังโปร่งที่ "อบ" จากโมเดล 3D ล่วงหน้า** เล่นด้วย CSS `steps()` (น้องวิ่งเล่นซุกซนหน้าป้าย rank · ภายหลังสลับตามสถานะ หิว/ดีใจ/ป่วย/หลับ ที่มีอยู่แล้วใน state.js)
