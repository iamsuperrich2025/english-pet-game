...
- **รอบ 1287 · Home V2 R19 (Admin Preview เท่านั้น):** ป้ายข้อความแนวตั้งทั้ง 29 ปุ่มขยายความสูงตามเนื้อหา รองรับหลายบรรทัด ไม่ตัดคำ/ไม่ใส่ `...`; ภาพจริง “Vocab World Racing” แสดงครบภายในกรอบ
- กำหนดโลกเฉพาะแอดมินตรงตามผู้ใช้ 6 โลก: ผจญภัย, Sky Playground, ขับรถ, มอเตอร์ไซค์, ยานแม่, หุ่นรบ; โลกผีสิง/เฮลิคอปเตอร์/โดรน FPV/ฟุตบอลเป็นสาธารณะ และทุกปุ่มยัง delegate ไป Classic เดิม
- regression + build ผ่าน; runtime วัดทุกปุ่มที่ 1323×622, 915×412 และ 667×375 ได้ `railLabelFailures=[]`, ไม่มี page overflow, Bottom Rail 13 ปุ่มยังเลื่อนแนวนอนและไม่มี vertical overflow
- **รอบ 1286–1284:** New Word/ข้อความเด็กอ่านง่าย, Global Feed ซื้อสินค้าตรงด้วยรหัส 6 หลัก, ผู้เล่นออนไลน์เต็มหน้า และปุ่มรักษาป่วยสีแดงยังคงเดิม; Home V2 ทั้งหน้ายัง gate ด้วย `isAdmin() === true` จนผู้ใช้ตรวจผ่าน
