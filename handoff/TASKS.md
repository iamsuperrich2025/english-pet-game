...
- **รอบ 1293 · Home V2 R24 (Admin Preview เท่านั้น):** ถอด Fantasy Dock/flyout ที่ซ้อนเป็นแถวสองและบังสัตว์ออกจาก DOM; คืนกิจกรรมภาษาอังกฤษเดิมทั้ง 13 ปุ่มลงรางล่างแถวเดียว
- สร้างผิวปุ่มใหม่แบบของเล่นแฟนตาซีพาสเทล—ไอคอนเหรียญ ขอบมน เส้นประ/ดาวเล็ก ตัวอักษรเข้ม—และเลื่อนซ้าย–ขวาด้วย touch/wheel/keyboard เหมือน Classic
- ลำดับและ handler/source เดิมของทั้ง 13 action ไม่เปลี่ยน, admin gate ยังเป็น `isAdmin() === true`; แก้เฉพาะ `home-v2.js/css`, cache-bust และ regression โดยไม่แตะงานร้านชุดนักรบหรือ `css/petshopping3d.css`
- syntax/regression/build `.1163` ผ่าน; พรีวิว 1323×622 และ 812×375 ยืนยัน 13 ปุ่ม, rowCount=1, overflow=0 และ petOverlap=false
