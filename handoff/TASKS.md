...
- syntax + policy 125/107 + refund idempotency + market regression + asset QA + production build + Edge 812×375 ผ่าน; Functions deploy แล้วและ dry-run พบ 4 ผู้เล่น/9 เค้กรับแล้ว/คืนรวม 105,000/escrow เดิม 1 รายการ/ไม่ deferred — รอ hosting deploy แล้วจึง live migration
