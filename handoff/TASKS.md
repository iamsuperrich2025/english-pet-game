...
- **รอบ 1355 · ป้ายภารกิจโรงแรมไม่ปิดเอง + จัด HUD ตามภาพผู้ใช้:** ป้ายเชิญ 2 login แรกปิดได้เฉพาะปุ่ม “ไปโรงแรมผีสิง”/“รับทราบ”; Escape และคลิกพื้นหลังถูกดักไว้ จึงอ่านค้างได้ไม่จำกัดเวลาเหมือนกล่องรางวัล
- ถอดตัวจับเวลา “อยู่ในโรงแรมนานเท่าไหร่” ออกจาก runtime/HUD ทั้งหมด และซ่อนปุ่ม “ไปหาเพื่อน” เฉพาะด่านโรงแรมโดยคงข้อความสถานะสนาม
- แยกป้าย “ภารกิจพิเศษเดี่ยว” ออกจากแถว HP/เหรียญไปไว้ `top:52px;right:136px` ใต้แถว เพื่อน/เปิด/ปิด/แชท/?/ออก และเลื่อนคำเป้าหมายโรงแรมลง `top:96px`
- special mission/Haunted Phase 4/rules/session-reset regression, syntax, production build `2026-09-04.1221`, PWA/cache/TWA validator และ Chrome DOM geometry QA ผ่านที่ 1372×293 + 812×375; overlap=false, hold 20 วินาที=true, Escape/backdrop ยังอยู่, กดรับทราบจึงปิด
