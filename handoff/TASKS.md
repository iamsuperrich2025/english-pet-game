...
- **รอบ 1354 · ภารกิจพิเศษเดี่ยวโรงแรมผีสิง:** ขยาย canonical run เป็น 5 คำ (ยังคง terminal `wordIndex=4` ตาม Firebase rules) และเพิ่มมิเตอร์ส่วนตัวที่นับเฉพาะคนชนะ transaction ของตัวอักษรสุดท้ายซึ่งตรงกับคำ; คำเพื่อนไม่นับ, GAME OVER/ออกโลกรีเซ็ตรอบ
- เก็บครบ 5 คำโดยไม่ตายรับ 10,000 เหรียญทันทีครั้งเดียวต่อบัญชี พร้อมเสียง+ภาพเงินเข้าและป้ายยินดีเหนือโลก 3D ซึ่ง Escape/คลิกฉากหลังปิดไม่ได้ ต้องกดรับทราบ; ป้ายเชิญขึ้นครั้งละ 1 ป้ายใน 2 login แรกและรอ blocker เดิมก่อนแสดง
- special mission/Haunted Phase 4/rules/session-reset regression, syntax, production build `2026-09-03.1220`, PWA/cache/TWA validator และ Chrome 812×375 visual+DOM QA ผ่าน (เงิน 1,000→11,000, sound 4 calls, login 1/2 ขึ้นและ 3 ไม่ขึ้น)
