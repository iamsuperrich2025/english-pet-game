...
- **รอบ 1294 · Home V2 R25 (Admin Preview เท่านั้น):** แก้ไอคอนรางล่างถูกดึงขึ้น/โดนตัดจาก `transform:translateY(-50%)` รุ่นเก่าที่ยังค้างหลัง R24 เปลี่ยนเป็น static และล้าง `height:100%` รุ่นเก่าของข้อความ
- reset geometry เฉพาะรางล่างให้ไอคอน/ข้อความกึ่งกลาง พร้อมลูกศรตามสถานะเลื่อน; คง 13 ปุ่มแถวเดียวและไม่มี flyout บังสัตว์
- เปลี่ยน SVG เฉพาะ 10 ปุ่มซ้ายที่ภาพไม่ตรงชื่อ (9 โลก + ตู้เข็ม); handler/source/order/admin gate เดิมไม่เปลี่ยน และไม่แตะ `css/petshopping3d.css`
- syntax/regression/build `.1164` ผ่าน; พรีวิวราง 1323×622/812×375 ได้ center error=0px, verticalOverflow=0 และแผ่นตรวจไอคอนใหม่ครบ 10 ภาพ
