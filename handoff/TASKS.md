...
- **รอบ 1165 · รถ Pet Shopping ไม่หลุดถนน + ปรับ UI รถ:** ต้นตอเดิมเพียงลดความเร็วนอกถนนและไม่มี guard/reset input จึงยังหลุดแนวหรือค้างพวงมาลัยได้
- บังคับจุดรถ/ปลาย GPS ให้อยู่บนถนนและคืน input เมื่อ pointer/หน้าต่างหลุด; ลดค่าชน 1,000 → 100 เหรียญ
- ไฟเลี้ยวส้มอำพัน 28px อยู่ในกรอบทุกจอ; เปลี่ยน Equalizer เป็น premium log-spectrum แบบ segmented, peak hold, glow/reflection และสเกล 20–20k Hz
- แก้ `petshopping3d.js/css` + regression; runtime route clamp, 812×375/1280×600, syntax/integration/dress, build `.1053` 8,336 ไฟล์ และ PWA validator ผ่าน
