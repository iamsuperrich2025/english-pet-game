...
PUBLIC ENTRY POINTS / KEY SYMBOLS: `window.VocabForce.open/close`, `NexAnimationController`, `LetterProgressController`, `VocabularyRoundController`, `LetterField.dropAround/applyPeerDrop`, `VocabForceNet.consumeDrops/consumeJumps/consumeOverdrive`, `VocabForceNet.roomHud`, `HealthBar`, `VF.DashTune`, `VF.OverdriveDashTune`, `VF.PowerJumpTune`, `VF.WIN_ACK_SEC`, `VF._t.winnerPhoto`, `VF._t.collusionJudge`, `VF._t.roomHud`, `VF._t.wantHunters`
