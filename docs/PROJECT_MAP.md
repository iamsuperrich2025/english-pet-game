...
NOTES: Inspect only the relevant loader/entry zone in `ui.js`. Round 1507: `openWorldEntryDialog` starts the world immediately with no free-play confirm overlay. Sky character picking stays in-world (`#sp-character`).
