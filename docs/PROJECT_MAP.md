...
SYSTEM: Vocab Force
PURPOSE: Isolated admin/dev third-person combat vocab hunt: scatter the round's letters across a 10× lot, complete the Shoot Word pool word for 5,000 coins, NetRoom `vforce` up to 14, hunter zombies when the room is sparse.
