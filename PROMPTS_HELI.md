...
## 3) 📢 ป้ายโฆษณาบนยอดตึก (รอบ 58 — ช่องขายโฆษณาจริง)

- ในเมืองมีป้ายโฆษณา **10 ป้าย เลข "ป้าย 1"–"ป้าย 10" กำกับมุมซ้ายบนทุกป้าย** · ผังเมือง seed คงที่ →
  **ป้ายเลขเดิมอยู่ตึกเดิมเสมอ ทุกเครื่องเห็นเหมือนกัน** — ให้ลูกค้าบินดูแล้วเลือกจองเลขป้ายได้เลย
- ยังไม่มีลูกค้า = พื้นหลังสีสัน/ลวดลายต่างกันทุกป้าย + ข้อความ **"ติดต่อโฆษณา โทร 064-357 6645"**
- **วิธีลงโฆษณาลูกค้า:** เซฟภาพเป็น `img/ads/ad_<เลขป้าย>.png` (เช่นลูกค้าจองป้าย 3 → `ad_3.png`)
  → commit+push → ภาพขึ้นแทนบนป้ายนั้นทันที ไม่ต้องแก้โค้ด (เลขป้ายมุมซ้ายยังโชว์ทับให้อ้างอิง)
- **สเปกภาพ:** สัดส่วน **8:3 แนวนอน** (แนะนำ 1024×384 px) · PNG · ภาพจะถูกวางเต็มป้ายเว้นกรอบขาว
- อยากเพิ่ม/ลดจำนวนป้าย: แก้ `AD_COUNT` ใน js/adventure3d.js
...
- [ ] `img/ads/ad_<n>.png` — โฆษณาลูกค้าขึ้นแทนป้ายเลขนั้น
