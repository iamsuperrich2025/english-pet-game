...
*/
const CACHE_VERSION = 'pet-vocab-v167';  // v167: 🌧️☀️ ชั้นกระจกห้องนักบินโลกเฮลิฯ มีชีวิต (ที่ปัดมีท่าจอด/รอยรีดน้ำ · แดดแฉก-ผี-ใบพัดตัดแสง · ฝ้าไอน้ำ · แสงจันทร์) รอบ 535
