...
assert(fx.includes('Round 1506')||fx.includes('รอบ 1506')||fx.includes('Round 1513')||fx.includes('รอบ 1513')||fx.includes('Round 1514')||fx.includes('รอบ 1514'),'round mark');
...
assert(/for\(let j=0;j<16;j\+\+\)/.test(fx)||/for\(let j=0;j<12;j\+\+\)/.test(fx),'outer ember/smoke puffs');
