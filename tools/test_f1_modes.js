...
assert.ok(ui.indexOf("F1Modes.openSelector")<ui.indexOf("openWorldEntryDialog(w);",ui.indexOf("F1Modes.openSelector")),
  'F1 selector must continue to entry-fee dialog, never charge first');
