...
/* R10.3 locked approved Visual Master direct-fidelity guard. */

must(home.includes("R10.3 Locked Visual Master Direct Fidelity Completion"), "R10.3 Home V2 JS marker missing");
...
must(indexClassic.includes("css/home-v2.css?v=1213") && indexClassic.includes("js/home-v2.js?v=1213"), "R10.3 Home V2 cache-bust version missing from index_classic.html");

must(home.includes('ADMIN PREVIEW · R10.3 LOCKED MASTER'), "R10.3 visible admin-preview marker missing");
...
console.log("PASS Home V2 R10.3 locked Visual Master direct fidelity + premium identity badge + illustrated semantic rail + focal fantasy banner + proportional live center overlays + locked coin/bottom rail + authoritative bindings + exact mobile landscape/iQOO-style preview checks");
