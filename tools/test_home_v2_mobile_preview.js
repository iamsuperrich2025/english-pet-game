...
must(indexClassic.includes("css/home-v2.css?v=1214") && indexClassic.includes("js/home-v2.js?v=1213"), "R10.4 color-pass CSS cache-bust / locked JS version missing from index_classic.html");
...
console.log("PASS Home V2 R10.4 color depth/contrast fidelity + R10.3 locked Visual Master structure + no global brightness darkening + premium local materials + locked coin/bottom rail + authoritative bindings + exact mobile landscape/iQOO-style preview checks");
