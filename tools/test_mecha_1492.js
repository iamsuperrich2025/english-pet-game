...
assert(fx.includes('รอบ 1492')||fx.includes('Round 1492')||fx.includes('Round 1505')||fx.includes('รอบ 1505'),'round mark');
...
assert(fx.includes('0xff812e')||fx.includes('0xff6a14')||fx.includes('FLAME=0xff6a14'),'arena fire orange');
