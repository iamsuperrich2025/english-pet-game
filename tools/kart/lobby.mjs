...
const browser=await chromium.launch({channel:'chrome',headless:true,args:['--enable-unsafe-swiftshader']}),page=await browser.newPage({viewport:{width:812,height:375}}),errors=[];page.on('pageerror',e=>errors.push(e.message));
try{
 ...
 console.log('PASS 8 real lobby checks',root,'page errors',errors);assert.deepEqual(errors,[]);
