...
console.log('PASS Frontline 1944 Phase 1.2.6 + 1.2.6A: 57 baseline acceptance checks + 7 diagnostics-cleanup checks pass; accepted DRIVE/AIM/FIRE stay locked and diagnostics are explicit opt-in only');
