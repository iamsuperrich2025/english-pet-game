...
const RUNTIME_ID='P2.1R12.1-0a2900';
...
assert.strictEqual(CFG.runtimeVersion,RUNTIME_ID,'Frontline runtime freshness identity marker is synchronized');
...
(function testR112ResponsiveHudMatrix(){
  ...
  assert(css.includes('--fl44-css-runtime-id:"P2.1R12.1-0a2900-CSS"'),'current CSS identity synchronized after R12');

  assert(css.includes('data-task-id="VW-20260906-182626-c85cc6"'),'R11.2 CSS task marker synchronized');

  assert(html.includes("var FRONTLINE_RUNTIME_ID='P2.1R12.1-0a2900';"),'current HTML loader identity synchronized after R12');
...
(function testR113Acceptance(){
  ...
  assert(source.includes("runtimeVersion:'P2.1R12.1-0a2900'"),'current JS runtime identity is R12');
  ...
  assert(css.includes('--fl44-css-runtime-id:"P2.1R12.1-0a2900-CSS"'),'current CSS identity is R12');

  assert(html.includes("var FRONTLINE_RUNTIME_ID='P2.1R12.1-0a2900';"),'current loader identity is R12');
...
(function testR12MissionExpansion(){
 ...
 assert(css.includes('--fl44-css-runtime-id:"P2.1R12.1-0a2900-CSS"'),'R12 CSS identity');

 assert(css.includes('.fl44-arrow[data-offscreen="true"]'),'off-screen objective guidance styling');

 assert(html.includes("var FRONTLINE_RUNTIME_ID='P2.1R12.1-0a2900';"),'R12 loader identity');
...
(function testR121DirectTargetForwardReturnAndMgRange(){
  const source=fs.readFileSync('js/frontline1944.js','utf8'),css=fs.readFileSync('css/frontline1944.css','utf8'),html=fs.readFileSync('index_classic.html','utf8');
  assert(source.includes("runtimeVersion:'P2.1R12.1-0a2900'"),'R12.1 JS delivery identity');
  assert(css.includes('--fl44-css-runtime-id:"P2.1R12.1-0a2900-CSS"'),'R12.1 CSS delivery identity');
  assert(html.includes("var FRONTLINE_RUNTIME_ID='P2.1R12.1-0a2900';"),'R12.1 loader identity');
