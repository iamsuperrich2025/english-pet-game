...
assert(/^P1\.2\.2-/.test(CFG.runtimeVersion),'Phase 1.2.2 direction-lock runtime version marker is explicit');
...
assert(code.includes("kind:'tank',phase:'1.2.2'")&&code.includes('__VW_FRONTLINE1944_RUNTIME__'),'loaded Frontline runtime publishes the Phase 1.2.2 authoritative tank-runtime identity marker');
...
console.log('PASS Frontline 1944 Phase 1.2.2: UP follows the visible hull arrow, DOWN is the exact opposite, right steering matches visual yaw, turret/world heading conversion is canonical, plus all Phase 1.2 foundation guards');
