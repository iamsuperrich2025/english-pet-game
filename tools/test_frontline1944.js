...
console.log('PASS Frontline 1944 Phase 1.2.6: all 57 deterministic acceptance checks pass; accepted DRIVE/AIM stay locked, FIRE is movable/persistent, safe global double-tap FIRE works, and the canonical desktop/tank runtime remains locked');
