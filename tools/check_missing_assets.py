...
REQUIRED_BUILD_ASSETS = (
    ...
    ("tools/build_web.mjs", "img/f1/cockpit_turn_center_blue.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_left_blue.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_right_blue.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_center_green.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_left_green.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_right_green.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_center_yellow.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_left_yellow.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_right_yellow.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_center_orange.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_left_orange.webp"),
    ("tools/build_web.mjs", "img/f1/cockpit_turn_right_orange.webp"),
