...
- ✅ **รอบ 49: พิธีประกาศแชมป์ใน map 🏁** — ครูกด "จบรอบแข่ง" → โพเดียม 🥇🥈🥉 ทุกเครื่อง + แตรฉลอง + โบนัส 100/50/25 + คะแนนรีเซ็ตเริ่มรอบใหม่ (`/class/<map>/podium` — **rules รอ publish ชุดเต็ม**) — version .27
