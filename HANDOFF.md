...
- ✅ **รอบ 37: เลือกตัวละครผู้เลี้ยง (ข้อ 4) + การ์ดตั๋วโลกผจญภัย (ข้อ 7) + 🐞 fix sw.js cache 404 รูป** (ภาพเจนใหม่ไม่โผล่ให้ผู้เล่นเก่า — CACHE_VERSION v2) · ภาพผู้ใช้เข้าแล้ว 3/11 — version .15
