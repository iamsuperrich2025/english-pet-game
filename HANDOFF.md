...
- 🐞 **งานถัดไป = บั๊กค้าง:** ส่งของขวัญจริง 2 บัญชี → toast ข้างล่างโดนบัง อ่านไม่ออก · ลองแก้ z-index แล้วยังไม่หาย → **อ่านหัวข้อ "🐞 บั๊กค้าง" บนสุดของ STATUS.md (มีสเต็ปดีบัก + ต้องขอ screenshot จากผู้ใช้ก่อน)**
