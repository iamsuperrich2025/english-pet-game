...
- ล่าสุด: ข้อ 0.5 ส่งของขวัญ + emoji แชท 7 หมวด + แยกแผงโรงงาน/ตลาด — push แล้ว
- ⚠️ **ค้างฝั่งผู้ใช้:** publish rules ใหม่ (เพิ่มโซน `/gifts`) + ทดสอบจริงบน Pages 2 บัญชี
- 🎯 งานถัดไปเลือกจาก BACKLOG (item 8 รายได้ออนไลน์ · item 2 ตลาดออนไลน์จริง · item 3 daily quest ฯลฯ)
