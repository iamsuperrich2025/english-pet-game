...
- ✅ **รอบ 75: แก้เปรตยืดเบี้ยว 👻** — สเกล `ghost_2` `2.7×6.4`→`3.6×6.0` baseY 3.15→2.96 · ของเดิมยืดแนวตั้ง ~2.4 เท่า (สัดส่วนตัว 2.29→5.42) หัวเป็นไข่ยาว/ตัวเป็นเส้น · ใหม่ H/W~3.8 สูงโย่งเท่าต้นตาลแต่ไม่บิด (ผู้ใช้เลือกเอง จากภาพเทียบ) — version .51 · **⚠️ ค้าง: `ghost_3`(แม่นาค)+`ghost_5`(ผ้าขาว) เป็นภาพแนวตั้ง 1024×1536 แต่โค้ดใช้สเกลจัตุรัส 2.6×2.6 → โดนบีบเตี้ยลง ~33% ยังไม่แก้**
