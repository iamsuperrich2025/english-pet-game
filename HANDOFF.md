...
- ✅ **รอบ 34: คิว 7725691507 ข้อ 5.1 แยกอาหารคน/สัตว์ + พิษสะสม เสร็จ** (version .12) — เมนู 2 ชุดตามชนิดสัตว์ · เตือนก่อนป้อนอาหารโทษ · บาร์พิษไม่ลดเอง เต็ม 100 ป่วยทันที · ขับพิษ 1,000 · ทดสอบ preview ครบ · push แล้ว commit `eb3ace0` — **รอผู้ใช้ทดสอบจริงบน Pages** (build หน่วง 2–5 นาที)
