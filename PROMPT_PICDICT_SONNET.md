...
| สถานะ | แผ่น |
|---|---|
| ✅ เสร็จแล้ว (รอบ 993 · Sonnet, มี session คู่ขนานช่วยทำ Toys/Transportation/Trees/Weather/WildAnimals/animal1/animal2/food) | Colors.png (ตรวจซ้ำแล้ว ถูกต้องตรงภาพ ไม่ต้องแก้) · Action Verbs.png · Adjectives.png · Bathroom.png · Bedroom.png · Birds.png · BodyParts.png · Classroom Objects.png · Clothes.png · DailyRoutines.png · Drinks.png · Family.png · FarmAnimals.png · Feelings.png · Flowers.png · Furniture.png · Hobbies.png · Holidays.png · House.png · Insects.png · Jobs.png · Kitchen.png · MusicalInstruments.png · Nature.png · Opposites.png · Places.png · Prepositions.png · Safety Signs.png · School.png · SeaAnimals.png · Seasons.png · Shapes.png · Space.png · Sports.png · Time.png · Tools.png · Toys.png · Transportation.png · Trees.png · Vegetables.png · Weather.png · WildAnimals.png · animal1.png · animal2.png · food.png · fruit.png |
| ⬜ คิวถัดไป | — (ครบทุกแผ่นแล้ว 🎉) |
| 📝 หมายเหตุ | เจอ Tools.png/Toys.png/Transportation.png/Vegetables.png/food.png ซ้ำ entry จาก session คู่ขนานหลายรอบ (rows/เนื้อหาไม่ตรงกันบ้าง) — ตรวจสอบและลบตัวซ้ำผิดออกแล้วทุกจุด (ยืนยันด้วย `grep -o "PICDICT_WORDS\['[^']*'\]" js/data/picdict_words.js \| sort \| uniq -d` ว่างเปล่า) · session ถัดไปเช็ก duplicate แบบนี้ก่อน commit เสมอ (มี session คู่ขนานทำงานพร้อมกัน) · animal2.png แถวสุดท้ายคอลัมน์5 ตัวอักษรอังกฤษบนภาพเพี้ยน ("Oystriin") แต่ภาพ+คำไทย "หอยตลับ" ชัดว่าคือ Oyster ใส่เป็น Oyster/หอยตลับ |
| 🚫 ข้าม (ผังไม่สม่ำเสมอ) | — |
