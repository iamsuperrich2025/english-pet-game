...
| สถานะ | แผ่น |
|---|---|
| ✅ เสร็จแล้ว (รอบ 992 · Fable ทำให้แล้ว แต่ให้**เปิดภาพตรวจซ้ำ 1 ครั้ง**โดยเฉพาะการ์ดแถว 3 "White สีขาวนวล" กับแถวล่าง "Pastel Blue" ว่าไทยตรงภาพไหม แล้วแก้ถ้าผิด) | Colors.png |
| ⬜ คิวถัดไป (เรียงตามนี้) | Action Verbs.png · Adjectives.png · Bathroom.png · Bedroom.png · Birds.png · BodyParts.png · Classroom Objects.png · Clothes.png · DailyRoutines.png · Drinks.png · Family.png · FarmAnimals.png · Feelings.png · Flowers.png · Furniture.png · Hobbies.png · Holidays.png · House.png · Insects.png · Jobs.png · Kitchen.png · MusicalInstruments.png · Nature.png · Opposites.png · Places.png · Prepositions.png · Safety Signs.png · School.png · SeaAnimals.png · Seasons.png · Shapes.png · Space.png · Sports.png · Time.png · Tools.png · Toys.png · Transportation.png · Trees.png · Vegetables.png · Weather.png · WildAnimals.png · animal1.png · animal2.png · food.png · fruit.png |
| 🚫 ข้าม (ผังไม่สม่ำเสมอ) | — |
